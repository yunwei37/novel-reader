...
export const translations: Translations = {
  en: {
    ...
    'settings.appDescription': 'A decentralized novel reader that prioritizes privacy by processing all data locally, with no login required.',
  ...
  zh: {
    ...
    'settings.appInfo': '关于',
    'settings.appDescription': '一个去中心化的小说阅读器，通过本地处理所有数据来保护隐私，无需登录。',
